...
namespace CGUTILS
{
	...
	public:
		...
		/// </summary>
		static bool IsAlmostEqualTo(double value1, double value2, double tolerance = DoubleEpsilon);

		static bool IsGreaterThan(double value1, double value2, double tolerance = DoubleEpsilon);

		static bool IsGreaterThanOrEqual(double value1, double value2, double tolerance = DoubleEpsilon);

		static bool IsLessThan(double value1, double value2, double tolerance = DoubleEpsilon);

		static bool IsLessThanOrEqual(double value1, double value2, double tolerance = DoubleEpsilon);
